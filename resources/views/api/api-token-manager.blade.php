<div>
    ...
    <x-ui.form-section submit="createApiToken">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-ui.input id="name" type="text" class="mt-1 block w-full" wire:model="createApiTokenForm.name" autofocus />
        ...
        <x-slot name="actions">
            <x-ui.action-message class="me-3" on="created">
                {{ __('Created.') }}
            </x-ui.action-message>
    ...
    <x-ui.dialog-modal wire:model.live="managingApiTokenPermissions">
        ...
        <x-slot name="footer">
            ...
            <x-ui.button class="ms-3" wire:click="updateApiToken" wire:loading.attr="disabled">
                {{ __('Save') }}
            </x-ui.button>
        </x-slot>
    </x-ui.dialog-modal>
    ...
    <x-ui.confirmation-modal wire:model.live="confirmingApiTokenDeletion">
        ...
        <x-slot name="footer">
            ...
            <x-ui.danger-button class="ms-3" wire:click="deleteApiToken" wire:loading.attr="disabled">
                {{ __('Delete') }}
            </x-ui.danger-button>
        </x-slot>
